   ...
   return (
      <section className="w-full bg-[#E6F8F8] py-16 px-4 sm:px-8 lg:px-16">
         <div className="max-w-6xl mx-auto text-center">
            {/* Top label */}
            <span className="inline-block mb-4 px-4 py-1 rounded-md bg-teal-600 text-white text-xs sm:text-sm font-medium">
               HOW IT WORKS
            </span>

            {/* Title */}
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-800 mb-10">
               Simple Steps to <span className="text-teal-600">Stay Secure.</span>
            </h2>

            <div className="bg-gradient-to-r from-gray-900 to-gray-800 text-white rounded-2xl p-6 sm:p-10 shadow-lg relative overflow-visible">
               ...
               <div className="flex flex-col sm:flex-row justify-center items-center gap-6 mb-20 relative">
                  ...
                  <div className="relative flex flex-col items-center">
                     <Card className="px-6 py-3 bg-teal-600 text-white rounded-xl shadow-sm text-sm sm:text-base font-medium">
                     ...
                     <div className="hidden lg:block absolute top-full left-1/2 transform -translate-x-1/2">
                        ...
                        <div className="h-0.5 w-[455px] bg-gray-400 -ml-[450px]" />
                  ...
                  {["Track", "Verify", "Communicate", "Respond Instantly When Needed"].map(
                     (step, i, arr) => (
                        <div key={step} className="relative flex flex-col items-center">
                           <Card className="px-6 py-3 bg-gray-800 text-white border border-gray-600 rounded-xl text-sm sm:text-base font-medium z-10">
                              {step}
                           </Card>
